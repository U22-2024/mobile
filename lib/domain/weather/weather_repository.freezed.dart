...
mixin _$WeatherState {
  bool get isRequireUmbrella => throw _privateConstructorUsedError;
...
abstract class $WeatherStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isRequireUmbrella, double maxRainfall});
}
...
class _$WeatherStateCopyWithImpl<$Res, $Val extends WeatherState>
  ...
  @override
  $Res call({
    Object? isRequireUmbrella = null,
    Object? maxRainfall = null,
  }) {
    return _then(_value.copyWith(
      isRequireUmbrella: null == isRequireUmbrella
          ? _value.isRequireUmbrella
          : isRequireUmbrella // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$WeatherStateImpl implements _WeatherState {
  const _$WeatherStateImpl(
      {required this.isRequireUmbrella, required this.maxRainfall});

  @override
  final bool isRequireUmbrella;
  @override
  final double maxRainfall;

  @override
  String toString() {
    return 'WeatherState(isRequireUmbrella: $isRequireUmbrella, maxRainfall: $maxRainfall)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isRequireUmbrella, isRequireUmbrella) ||
                other.isRequireUmbrella == isRequireUmbrella) &&
            (identical(other.maxRainfall, maxRainfall) ||
                other.maxRainfall == maxRainfall));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isRequireUmbrella, maxRainfall);
...
abstract class _WeatherState implements WeatherState {
  const factory _WeatherState(
      {required final bool isRequireUmbrella,
      required final double maxRainfall}) = _$WeatherStateImpl;

  @override
  bool get isRequireUmbrella;
  @override
